...
BOT_NAME: process.env.BOT_NAME || "kyng_mikel ✌🏻", // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ kyng mikel ᴛᴇᴄʜ*"; // Input Yours custom...(Maintain font for Flow)
